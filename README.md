...
## Beyond the four: forcing, chaos and Van der Pol

The four prototypes above are exact by pieces and have limit cycles, and
that is where this document stops. Everything that builds on them — a
fifth prototype with a second threshold, what a periodic drive does to the
