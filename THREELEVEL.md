...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0.2 | $`-0.093`$ | 0.178 | 0.52 | 1.226 | 2.177 | 2.233 (+11.6%) | 6.305 (+0.1%) | 2.08 vs 2.09 | — | 18 |
...
Power laws through the fits (8 points): $`\zeta_0 = -0.367\,\mu^{0.936}`$; $`\zeta_1 = +0.808\,\mu^{0.955}`$; $`\zeta_2 = +3.262\,\mu^{1.164}`$; edges $`a = 1.203 \pm 0.051`$, $`b = 2.124 \pm 0.094`$.
<!-- /FITTABLE -->
